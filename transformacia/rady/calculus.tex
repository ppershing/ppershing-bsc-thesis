...
\begin{veta}
    ...
    v \todo{ref}. Nech $a_n',b_n',c_n'$ sú koeficienty $f'$.
    Potom 
    \begin{equation}
...
Skombinovaním prechádzajúcej vety s vetou \todo{ref: bodova konv}
dostaneme tvrdenie
\begin{veta}
...
\begin{dokaz}
  Pretože $f'\in \PSinf$, podľa \todo{ref} jej Fourierov rad
...
\begin{dokaz}
    ...
    \end{equation}
    Potom podľa vety \todo{ref ako v predchadzajucej vete} je jej
...
\end{veta}
\begin{dokaz}
    Podľa vety \todo{ref: bodova konv} vieme, že Fourierov rad
    ...
    \end{equation}
    Podľa \todo{ref} je $c_n = \frac{c_n'}{\imag n}, n\not=0$.
    Potom
    \begin{equation}
    ...
    \end{equation}
     kde sme využili Cauchy-Schwarzovu nerovnosť (\todo{ref}).
