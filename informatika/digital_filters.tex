...
fotografia, hudba prehrávaná\footnote{\todo{Prehral si}} z pásky atď.
...
\end{equation*}
kde $SNR{f} = S(f)/N(f)$ je \todo{`signal-to-noise ratio`}. Ak je šum
...
\todo{nejaky obrazok filtra}
\todo{nejaky rozumnejsi zaver?}
\todo{lit}%http://en.wikipedia.org/wiki/Wiener_deconvolution
